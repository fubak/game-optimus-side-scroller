...
const CELL_PAD = 2;
/**
 * World-space draw size for Optimus (~1.6–1.8× the 10×22 collision box). Visual only — hitbox
 * stays `PLAYER_WIDTH`×`PLAYER_HEIGHT`. Kept close to the AABB so stomps/ledges still read.
 */
export const WORLD_DRAW_WIDTH = 18;
export const WORLD_DRAW_HEIGHT = 40;
...
export const ENEMY_VISUAL_SCALE = 1.2;
